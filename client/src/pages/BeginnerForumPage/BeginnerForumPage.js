...
const BeginnerForumPage = _ => {
  ...
  forumState.handleAddPost = event => {
    ...
    addForumPost({topic: "beginner", title: forumState.title, post: forumState.post })
  ...
  return (
    <ForumContext.Provider value={forumState}>
      <NavBar />
      <h1 style={{ textAlign: 'center' }}>Beginner Forum</h1>
      <ForumPostForm />
      <ForumPostDisp />
...
export default BeginnerForumPage